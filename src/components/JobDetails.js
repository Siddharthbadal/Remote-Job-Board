    ...
    const jobDetailsHTML = `
        ...
        <div class="job-details__other">
            <section class="qualifications">
                ...
                <ul class="qualifications__list">
                    ...
                    ${jobItem.qualifications.map(qualification => 
                        `<li class='qualifications__item'>${qualification}</li>`).join('')}
            ...
            <section class="reviews">
                ...
                ${jobItem.reviews.map(review =>`<li class='reviews__item'>${review}</li>`).join('')}
        ...
        <footer class="job-details__footer">
            <p class="job-details__footer-text">If possible, please reference that you found the job on <span class="u-bold">devRoles</span>, we would really appreciate it!</p>
        </footer>
        
        `;

        // insert in the right element
        jobDetailsContentEl.innerHTML = jobDetailsHTML;

        // above qualifications is a list so need to format
