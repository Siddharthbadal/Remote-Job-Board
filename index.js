...
const jobsAvilableEL= document.querySelector('.jobs-available');
...
// https://bytegrad.com/course-assets/js/2/api/jobs
    ...
    fetch(`https://techsidh1.github.io/feedback-data-api/jobs.json?search=${searchText}`)
        .then(response => {
            if (!response.ok){
    ...
    .then(data => {
        ...
        <div class="job-details__other">
            <section class="qualifications">
                ...
                // qualifications is a list so need to format
